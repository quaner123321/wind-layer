...
import vert from '../../../shaders/barb.vert.glsl';
import frag from '../../../shaders/barb.frag.glsl';
...
export interface BarbPassOptions {
  source: SourceType;
  texture: Texture;
  textureNext: Texture;
  bandType: BandType;
 ...
 * barb
 */
export default class BarbPass extends Pass<BarbPassOptions> {
  #mesh: WithNull<Mesh>;
  ...
  constructor(id: string, renderer: Renderer, options: BarbPassOptions = {} as BarbPassOptions) {
